...
class QnAMaker {
    ...
    async getAnswers(context, options, telemetryProperties, telemetryMetrics) {
        ...
        if (question.length > 0) {
            const answers = await this.generateAnswerUtils.queryQnaService(this.endpoint, question, queryOptions);
            const sortedQnaAnswers = generateAnswerUtils_1.GenerateAnswerUtils.sortAnswersWithinThreshold(answers, queryOptions);
     ...
     */
    async callTrainAsync(feedbackRecords) {
    ...
    async callService(endpoint, question, top) {
        return this.generateAnswerUtils.queryQnaService(endpoint, question, { top });
    }
    /**
